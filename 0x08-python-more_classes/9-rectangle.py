...
class Rectangle:
    ...
    Returns:
        Rectangle: The Rectangle instance with a greater
        area or the first one in case of equal areas.
    ...
    def square(cls, size=0):
        """
        Create a square instance of the class with equal width and height.
        ...
        Returns:
           An instance of the class representing a square
